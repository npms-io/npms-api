...
const finalScore = '(doc["score.detail.popularity"].value * weightPopularity + ' +
        ...
        body: {
            ...
            query: {
                function_score: {
                    ...
                    script_score: {
                        lang: 'groovy',
                        script: `(doc["name.raw"].value.equals(name)) ? 100000 + ${finalScore} : _score * pow(${finalScore}, effect)`,
                        params: {
                            name: value,
                            effect,
