...
module.exports = (router, npmsNano, esClient) => {
     ...
     *     curl "https://api.npms.io/package/react"
     */
    ...
    /**
     * @api {post} /package/mget Get several packages info
     * @apiName mget-info
<<<<<<< HEAD:lib/routes/package/info.js
     * @apiGroup package
=======
     * @apiGroup module
     * @apiVersion 1.0.0
>>>>>>> master:lib/routes/module/info.js
     *
     ...
     *     curl -X POST "https://api.npms.io/package/mget" \
